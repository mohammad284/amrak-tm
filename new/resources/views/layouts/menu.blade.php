...
@endcan
@can('packages.index')
<li class="nav-header">{{trans('lang.Packages')}}</li>
    <li class="nav-item has-treeview ">
        <a href="#" class="nav-link "> @if($icons)
                <i class="nav-icon fas fa-money-check-alt"></i>@endif
            <p>{{trans('lang.Packages')}}<i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('packages*') ? 'active' : '' }}" href="{!! route('packages.index') !!}">@if($icons)
                    <i class="nav-icon fas fa-money-bill-wave"></i>@endif<p>{{trans('lang.Packages')}}</p></a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('subscript*') ? 'active' : '' }}" href="{!! route('subscript.index') !!}">@if($icons)
                    <i class="nav-icon fas fa-money-bill-wave"></i>@endif<p>{{trans('lang.Packages_users')}}</p></a>
            </li>
        </ul>
    </li>
@endcan
