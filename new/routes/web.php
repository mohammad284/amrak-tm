...
Route::get('index', 'SubscriptController@index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('packages', 'PackageController')->except([
        'show'
    ]);
    Route::resource('packages', 'PackageController')->except([
        'create', 'store', 'edit', 'update', 'destroy','users'
    ]);
    ...
    Route::resource('subscript', 'SubscriptController')->except([
        'show'
    ]);
